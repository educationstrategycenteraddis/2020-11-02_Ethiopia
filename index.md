...
venue: "Hosted by SADiLaR, South Africa "        # brief name of host site without address (e.g., "Euphoric State University")
...
longitude: "27.0929584"    # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "May 5-7, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "8:30 am - 16:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Samar Elsheikh", "Caroline Fadeke Ajilogba","Martin Dreyer", "Angelique van Rensburg ","François Michonneau", "Maneesha Sane", "Dimakatso Mathe", "Andiswa Bukula", "Phathutshedzo Maxwell Ramukhadi"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Sebastian Mosidi", ""Serah Rono"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes:  https://docs.google.com/document/d/1SPTdeMwOzQaZIJ8-lp6rZCZtuwCJc1s2TTy-g-u7xbA/edit   # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
